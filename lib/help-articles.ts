...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    summary: "Paste a collection link and track every product in it.",
    category: "Getting started",
  content: () => null,
  },
  {
    slug: "csv-upload",
    title: "Adding products from a spreadsheet",
    summary: "Upload a spreadsheet of links to track lots of products in one go.",
    category: "Getting started",
  content: () => null,
  },
  {
    ...
    summary: "What each card, list and feed on the dashboard is telling you.",
    category: "Features",
  content: () => null,
  },
  {
  ...
  },
  {
    ...
    summary: "See several competitors' price history on one chart.",
    category: "Features",
  content: () => null,
  },
  {
    slug: "troubleshooting-crawls",
    title: "Why isn't my product updating?",
